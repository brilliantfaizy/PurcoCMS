...
!function( $ ) {
	...
	var dates = $.fn.fdatepicker.dates = {
		...
		pl: {
			days: ["Niedziela", "Poniedzialek", "Wtorek", "Sroda", "Czwartek", "Piatek", "Sobota", "Niedziela"],
			daysShort: ["Nie", "Pon", "Wt", "Sr", "Czw", "Pt", "Sob", "Nie"],
			daysMin: ["Nd", "Po", "Wt", "Sr", "Czw", "Pt", "So", "Nd"],
			months: ["Styczen", "Luty", "Marzec", "Kwiecien", "Maj", "Czerwiec", "Lipiec", "Sierpien", "Wrzesien", "Pazdziernik", "Listopad", "Grudzien"],
			monthsShort: ["Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "Paz", "Lit", "Gru"],
			today: "Dzisiaj"
		},
		es: {
		...
		hu: {
		    days: ["Vasárnap", "Hétfo", "Kedd", "Szerda", "Csütörtök", "Péntek", "Szombat", "Vasárnap"],
		...
		cz: {
			days: ["Nedele", "Pondelí", "Úterý", "Streda", "Ctvrtek", "Pátek", "Sobota", "Nedele"],
			daysShort: ["Ne", "Po", "Út", "St", "Ct", "Pá", "So", "Ne"],
			daysMin: ["Ne", "Po", "Út", "St", "Ct", "Pá", "So", "Ne"],
			months: ["Leden", "Únor", "Brezen", "Duben", "Kveten", "Cerven", "Cervenec", "Srpen", "Zárí", "Ríjen", "Listopad", "Prosinec"],
			monthsShort: ["Led", "Úno", "Bre", "Dub", "Kve", "Cer", "Cnc", "Srp", "Zár", "Ríj", "Lis", "Pro"],
			today: "Dnes"
		},
		nl: {
		...
		el: {
            days: ["????a??", "?e?t??a", "???t?", "?et??t?", "??µpt?", "?a?as?e??", "S?ßßat?", "????a??"],
            daysShort: ["???", "?e?", "???", "?et", "??µ", "?a?", "S?ß", "???"],
            daysMin: ["??", "?e", "??", "?e", "??", "?a", "S?", "??"],
            months: ["?a????????", "Feß????????", "???t???", "?p??????", "?????", "???????", "???????", "?????st??", "Sept?µß????", "??t?ß????", "???µß????", "?e??µß????"],
            monthsShort: ["?a?", "Feß", "?a?", "?p?", "?a?", "???", "???", "???", "Sep", "??t", "??e", "?e?"],
            today: "S?µe?a"
        }
	};
