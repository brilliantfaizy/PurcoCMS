...
<script>
	$().ready(function() {
		...
		$("#signupForm").validate({
		   rules: {
			...
			messages: {
               ...
               {
                    $.ajax({
                            url: "<?php echo $base; ?>/index.php/InvolvedPartyController/AddInvolvedPartyType",
     ...
     function updatepartytype(){
                    $.ajax({
                    url:"<?php echo $base; ?>/index.php/InvolvedPartyController/updatepartytype",    
                     data: GetFormValues('signupForm'),
                    type: "POST",
                    success: function(data){
                    var myobj;
    ...
    $.ajax({
        url: "<?php echo $base; ?>/index.php/InvolvedPartyController/getTypeOfPartyAll",
        type:'POST',
        //data:{data},
        success: function(data) {
...
function editpartytype(id){
                 $('#signupForm').show();
                    $.ajax({
                    url:"<?php echo $base; ?>/index.php/InvolvedPartyController/editpartytype",    
                     data: {id: id},
                    type: "POST",
                    success: function(data){
                    var myobj;
...
function deletepartytype(id)
{
      var result = confirm("Want to delete?");
        if (result) {
           $.ajax({
          type: "GET",
          url: "<?php echo $base;?>/index.php/InvolvedPartyController/deletepartytype/"+id,
...
<div id="content">
    <div id="innerMenu">
                ...
                <ul>
                    <li><a class="innerMenuActive" href="#" onclick="viewadd(); return false;">Add Involved Party</a> </li>
                </ul>
